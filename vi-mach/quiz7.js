// Quiz 7 questions data - Công suất và Tối ưu hóa
const questions = [
    {
        question: "Thành phần công suất chủ yếu trong mạch CMOS khi chuyển mạch là:",
        options: [
            "Công suất rò rỉ",
            "Công suất tĩnh",
            "Công suất quiescent",
    ...
    {
        question: "Công suất tĩnh trong mạch CMOS tồn tại khi:",
        options: [
            "Không có điện áp nguồn",
            "Mạch ở tràng thái nghỉ",
            "Tín hiệu đang chuyển mạch",
            "Mạch hoạt động ở tần số cao"
        ],
        correctAnswers: [1],
        type: "single"
    },
    {
        question: "Thành phần công suất động chủ yếu do:",
        options: [
            "Sạc và xả điện dung tải",
            "Rò rỉ qua cổng logic",
            "Dòng điện ngược",
            "Dòng rò"
        ],
        correctAnswers: [0],
    ...
    {
        question: "Một mạch có công suất rò 0.2 nW và công suất động 0.8mW. Tổng công suất tiêu thụ là____________mW.",
        instruction: "Điền số thích hợp:",
        type: "fill-in",
        acceptedAnswers: ["1", "1.0"],
        correctAnswer: "1"
    },
    {
        question: "Công suất rò (Leakage Power) phụ thuộc mạnh vào:",
        options: [
            "Tần số xung nhịp",
            "Nhiệt độ và điện áp ngưỡng transistor",
            "Điện dung tải",
            "Dòng điện động"
        ],
        correctAnswers: [1],
    ...
    {
        question: "Phép thành phần công suất với đặc điểm:",
        instruction: "Kéo thả đặc điểm vào loại công suất tương ứng",
        type: "drag-drop",
        zones: [
            { id: "zone-static", title: "Ptĩnh", correctItem: "item-static" },
            { id: "zone-short", title: "Pngắn mạch", correctItem: "item-short" },
            { id: "zone-dynamic", title: "Pđộng", correctItem: "item-dynamic" }
        ],
        items: [
            { id: "item-static", text: "Do dòng rò khi mạch không hoạt động" },
            { id: "item-short", text: "Do cả NMOS và PMOS cùng dẫn trong chuyển mạch" },
            { id: "item-dynamic", text: "Do sạc/xả điện dung tải" }
        ]
    },
    {
        question: "Hai thành phần chính của công suất tiêu thụ trong mạch CMOS là:",
        options: [
            "Công suất động",
            "Công suất tổn hao dây dẫn",
            "Công suất từ trường",
            "Công suất tĩnh"
        ],
        correctAnswers: [0, 3],
    ...
    {
        question: "Công suất tiêu thụ trung bình trong mạch CMOS tỷ lệ thuận với tần số xung nhịp và ____________",
        instruction: "Điền từ thích hợp:",
        type: "fill-in",
        acceptedAnswers: ["Bình phương điện áp nguồn"],
        correctAnswer: "Bình phương điện áp nguồn"
    },
    {
        question: "Giảm tần số xung nhịp có thể giảm công suất động.",
        options: [
            "Đúng",
            "Sai"
        ],
    ...
    {
        question: "Tăng kích thước transistor sẽ luôn giảm công suất tổng.",
        options: [
            "Đúng",
            "Sai"
        ],
    ...
    {
        question: "Kỹ thuật Clock Gating được sử dụng để:",
        options: [
            "Giảm dòng rò của transistor",
            "Tăng tần số hoạt động",
            "Giảm công suất động bằng cách tắt xung clock khi không cần thiết",
            "Giảm điện áp nguồn"
        ],
        correctAnswers: [2],
        type: "single"
    ...
    {
        question: "Dynamic Voltage Scaling (DVS) là kỹ thuật:",
        options: [
            "Giữ điện áp cố định trong mọi trạng thái",
            "Tăng điện áp để cải thiện tốc độ",
            "Giảm dòng rò trong transistor",
            "Thay đổi điện áp và tần số tùy theo tải để giảm công suất tiêu thụ"
        ],
        correctAnswers: [3],
        type: "single"
    },
    {
        question: "Power Gating được dùng chủ yếu để:",
        options: [
            "Giảm công suất tĩnh bằng cách ngắt nguồn của các khối không hoạt động",
            "Giảm công suất động",
            "Giảm điện dung tải",
    ...
    {
        question: "Ở cấp độ kiến trúc, tối ưu hóa công suất có thể thực hiện bằng cách:",
        options: [
            "Tăng kích thước transistor",
            "Thiết kế pipeline hợp lý để giảm số lần chuyển mạch",
            "Giảm tần số clock toàn hệ thống",
            "Giảm VDD"
        ],
        correctAnswers: [1],
        type: "single"
    ...
    {
        question: "Kéo thả ghép cấp độ thiết kế với phương pháp tối ưu hóa tương ứng:",
        instruction: "Kéo thả phương pháp vào cấp độ tương ứng",
        type: "drag-drop",
        zones: [
            { id: "zone-circuit", title: "Mạch", correctItem: "item-pg" },
            { id: "zone-system", title: "Hệ thống", correctItem: "item-dvs" },
            { id: "zone-arch", title: "Kiến trúc", correctItem: "item-cg" }
        ],
        items: [
            { id: "item-pg", text: "Power gating" },
            { id: "item-dvs", text: "Dynamic voltage scaling" },
            { id: "item-cg", text: "Clock gating" }
        ]
    },
    {
        question: "Tăng điện áp ngưỡng luôn làm tăng tốc độ chuyển mạch.",
        options: [
            "Đúng",
            "Sai"
        ],
    ...
    {
        question: "Dynamic Voltage Scaling cho phép điều chỉnh điện áp tùy theo tải xử lý.",
        options: [
            "Đúng",
            "Sai"
        ],
    ...
    {
        question: "Hai cách phổ biến giảm công suất động là:",
        options: [
            "Tăng điện dung tải",
            "Giảm điện áp VDD",
            "Giảm hoạt động chuyển mạch",
            "Giảm tần số clock"
        ],
        correctAnswers: [1, 2],
        type: "multiple"
    ...
    {
        question: "Một mạch có công suất tĩnh chiếm 40% tổng công suất. Khi áp dụng power gating, phần này giảm 90%. Tổng công suất giảm khoảng ____________%",
        instruction: "Điền số thích hợp:",
        type: "fill-in",
        acceptedAnswers: ["36"],
        correctAnswer: "36"
