// Quiz 8 questions data - Dây dẫn và Kết nối
const questions = [
    {
        question: "Trong vi mạch, dây dẫn (interconnect) có vai trò chính là:",
        options: [
            "Tạo dao động tín hiệu",
            "Khuếch đại công suất",
            "Lưu trữ điện tích",
            "Truyền tín hiệu giữa các phần tử mạch"
        ],
        correctAnswers: [3],
        type: "single"
    },
    {
        question: "Hằng số điện môi của lớp cách điện (dielectric) giữa các dây dẫn ảnh hưởng trực tiếp đến:",
        options: [
            "Điện trở dây",
            "Điện dung ký sinh",
            "Điện áp ngưỡng",
    ...
    {
        question: "Hiệu ứng “RC delay” trong dây dẫn là do:",
        options: [
            "Giảm công suất tĩnh",
            "Tốc độ chuyển mạch transistor",
            "Điện trở và điện dung ký sinh của dây gây trễ tín hiệu",
            "Dòng rò rỉ làm mất tín hiệu"
        ],
        correctAnswers: [2],
        type: "single"
    },
    {
        question: "Hiệu ứng “Cross-talk” (nhiễu xuyên âm) giữa các dây dẫn xảy ra khi:",
        options: [
            "Hai dây có điện dung ký sinh lẫn nhau",
            "Điện trở dây dẫn quá cao",
            "Tín hiệu bị phản xạ tại đầu dây",
    ...
    {
        question: "Dây dẫn dài có thể coi như phần tử RC phân bố.",
        options: [
            "Đúng",
            "Sai"
        ],
    ...
    {
        question: "Điện dung ký sinh càng lớn thì tốc độ truyền tín hiệu càng nhanh.",
        options: [
            "Đúng",
            "Sai"
        ],
    ...
    {
        question: "Hai yếu tố vật lý quyết định độ trễ truyền tín hiệu qua dây dẫn là:",
        options: [
            "Điện trở dây",
            "Dòng rò",
            "Điện dung ký sinh",
    ...
    {
        question: "Chọn 3 đại lượng đặc trưng cho đặc tính điện của dây dẫn liên kết (interconnect) trong vi mạch:",
        options: [
            "Điện dung (C)",
            "Cảm kháng (L)",
            "Dòng rò tĩnh (Ioff)",
            "Hệ số truyền công suất (n)",
            "Điện trở (R)"
        ],
    ...
    {
        question: "Thành phần chủ yếu ảnh hưởng đến độ trễ kết nối là:",
        options: [
            "Nhiệt độ môi trường",
            "Tần số xung nhịp",
            "Dòng điện transistor",
    ...
    {
        question: "Kỹ thuật “interconnect scaling” được dùng để:",
        options: [
            "Tăng kích thước dây dẫn",
            "Tăng điện dung dây dẫn",
            "Giảm kích thước và khoảng cách giữa các dây để tăng mật độ mạch",
            "Giảm số lượng lớp kim loại"
        ],
        correctAnswers: [2],
        type: "single"
    },
    {
        question: "Hiện tượng “Cross-talk” tăng khi:",
        options: [
            "Khoảng cách giữa các dây giảm",
            "Khoảng cách giữa các dây tăng",
            "Số lượng lớp kim loại tăng",
            "Điện áp giảm"
        ],
        correctAnswers: [0],
        type: "single"
    ...
    {
        question: "Hiện tượng “Electromigration” gây ra:",
        options: [
            "Đứt mạch hoặc hỏng dây dẫn",
            "Tăng độ bền dây dẫn",
    ...
    {
        question: "Một trong các phương pháp tối ưu hóa kết nối là:",
        options: [
            "Tăng tần số hoạt động",
            "Giảm lớp kim loại",
            "Tăng chiều rộng dây và dùng vật liệu điện môi thấp (low-k)",
            "Tăng điện áp nguồn"
        ],
        correctAnswers: [2],
        type: "single"
    ...
    {
        question: "Khoảng cách dây nhỏ:",
        options: [
            "Cross-talk tăng",
            "Điện trở tăng",
            "Nguy cơ electromigration"
        ],
        correctAnswers: [0],
        type: "single"
    },
    {
        question: "Tiết diện dây giảm:",
        options: [
            "Cross-talk tăng",
            "Điện trở tăng",
            "Nguy cơ electromigration"
    ...
    {
        question: "Tăng lớp kim loại luôn làm tăng điện dung ký sinh.",
        options: [
            "Đúng",
            "Sai"
        ],
    ...
    {
        question: "Giảm chiều dài dây dẫn giúp giảm trễ và công suất tiêu thụ.",
        options: [
            "Đúng",
            "Sai"
        ],
    ...
    {
        question: "Hai yếu tố vật lý chính ảnh hưởng đến trễ kết nối là:",
        options: [
            "Điện trở dây dẫn",
            "Dòng rò",
            "Điện dung ký sinh",
    ...
    {
        question: "Kỹ sư cần giảm nhiễu giữa hai đường tín hiệu song song. Biện pháp hiệu quả nhất là ____________",
        instruction: "Điền từ thích hợp (4 từ):",
        type: "fill-in",
        acceptedAnswers: ["Tăng khoảng cách dây"],
        correctAnswer: "Tăng khoảng cách dây"
    },
    {
        question: "Giảm trễ đường dây dài trong chip, kỹ sư nên:",
        options: [
            "Dùng điện môi có hằng số cao",
            "Chia dây thành nhiều đoạn và chèn buffer",
            "Tăng điện áp nguồn",
            "Giảm chiều rộng dây"
        ],
        correctAnswers: [1],
